...
src/wubu_vision_encoder.o: src/wubu_vision_encoder.c include/wubu_vision_encoder.h include/gguf_reader.h
...
wubu_endurance: tools/wubu_endurance.c src/wubu_hive.o src/wubu_amoeba.o src/wubu_moe2.o src/wubu_diagnosis.o src/wubu_lineage.o src/wubu_contracts.o src/wubu_priority_store.o src/wubu_harness.o src/wubu_trajcell.o src/wubu_loopguard.o src/wubu_metadiag.o src/wubu_prover2.o src/wubu_hyper.o src/wubu_events.o src/wubu_resources.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)
...
wubu_timeseries: tools/wubu_timeseries.c src/wubu_events.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)
...
logit_probe: tools/logit_probe.c $(CPU_OBJ) src/wubu_tokenizer.o src/wubu_kernel_cuda.o
	$(CXX) $(CFLAGS) -DWUBU_ENABLE_CUDA -I include -o $@ $< $(CPU_OBJ) src/wubu_tokenizer.o src/wubu_kernel_cuda.o $(LDFLAGS) -L$(CUDA_LIBDIR) -lcudart -lstdc++
...
gen_text_cpu: src/wubu_model_cpu.o src/wubu_moe_cpu.o src/wubu_dense_ffn.o $(filter-out src/wubu_moe.o src/wubu_model.o src/wubu_dense_ffn.o,$(CORE_OBJ)) src/wubu_tokenizer.o
	$(CC) $(CFLAGS_FILTERED) -o $@ tools/gen_text.c src/wubu_model_cpu.o src/wubu_moe_cpu.o src/wubu_dense_ffn.o $(filter-out src/wubu_moe.o src/wubu_model.o src/wubu_dense_ffn.o,$(CORE_OBJ)) src/wubu_tokenizer.o $(LDFLAGS)

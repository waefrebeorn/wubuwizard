...
echo ""
echo "IQ1_M support is ALREADY in-tree (the module registry, 2026-08-09):"
echo "  1. GGML_TYPE_IQ1_M enum: include/gguf_reader.h"
echo "  2. IQ1_M dequant: src/gguf_reader.c (dequantize_iq1_m_row, ~line 1688)"
echo "  3. Dot product kernel: src/quantized_dot_generic.c"
echo ""

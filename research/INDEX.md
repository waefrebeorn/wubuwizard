...
- AM01 FULL-BODY PLAN (research/044-amoeba-grow-shrink-plan.md -- the plan at .hermes/plans/2026-08-03-amoeba-grow-shrink-expanded-tokenization.md): the seed only GROWS layers today (wubu_grow_insert/stack, monotonic Zhiqi Bu schedule, no shrink). The amoeba body needs symmetric morphing: depth (ShortGPT BI-score removal + LaCo merge, arXiv:2403.03853/2402.11187), width+FFN (Net2Net function-preserving grow, arXiv:2607.14571 gate-zero; low-norm prune), vocab (corpus-count prune), selectors; EVERY op pairs with a wubu_train_* reverse op; block slots become hive-backed (freelist pop/push = the membrane). `open`

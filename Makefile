...
test_ecosystem: tools/test_ecosystem.c src/wubu_ecosystem.o src/wubu_mobius.o src/wubu_hive.o src/gguf_reader.o
	$(CC) $(CFLAGS) -I include -o $@ $^ -lm
	./$@

src/wubu_ecosystem.o: src/wubu_ecosystem.c include/wubu_ecosystem.h include/wubu_mobius.h include/wubu_hive.h

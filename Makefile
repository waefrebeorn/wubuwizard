...
test_userfs: tools/test_userfs.c src/wubu_userfs.o src/wubu_kvfs.o src/wubu_encoder_impl.o src/wubu_encoder.o src/wubu_imgenc.o src/wubu_audio.o
	$(CC) $(CFLAGS) -I include -o $@ $^ -lm
	./$@
